...
mixin _$FastLaughState {
  List<Home> get videoList => throw _privateConstructorUsedError;
  bool get isLoading => throw _privateConstructorUsedError;
  bool get idError => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Home> videoList, bool isLoading, bool idError});
}
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      idError: null == idError
          ? _value.idError
          : idError // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$_Initial implements _Initial {
  const _$_Initial(
      {required final List<Home> videoList,
      required this.isLoading,
      required this.idError})
      : _videoList = videoList;

  final List<Home> _videoList;
  @override
  List<Home> get videoList {
  ...
  @override
  String toString() {
    return 'FastLaughState(videoList: $videoList, isLoading: $isLoading, idError: $idError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.idError, idError) || other.idError == idError));
  }

  @override
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_videoList), isLoading, idError);
...
abstract class _Initial implements FastLaughState {
  const factory _Initial(
      ...
      required final bool idError}) = _$_Initial;
